    ...
    <div className="sticky bottom-0 left-0 right-0 bg-stone-50/80 backdrop-blur-lg border-t border-stone-200 p-4 md:p-6 pb-8 z-40 transition-all">
      <div className="max-w-3xl mx-auto">
        ...
        <form 
          ...
          className={`relative group bg-white rounded-xl shadow-lg border transition-all duration-300 ${
            isLoading ? 'border-stone-200 opacity-80' : 'border-stone-300 hover:border-amber-400 focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500/20'
          }`}
        >
