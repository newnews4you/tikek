...
export const InputArea: React.FC<InputAreaProps> = ({ onSendMessage, isLoading }) => {
    ...
    return (
        <div className="sticky bottom-0 left-0 right-0 bg-stone-50/80 backdrop-blur-lg border-t border-stone-200 p-4 md:p-6 pb-8 z-40 transition-all">
            <div className="max-w-3xl mx-auto">
                ...
                <form
                    ...
                    className={`relative group bg-white rounded-xl shadow-lg border transition-all duration-300 ${isLoading ? 'border-stone-200 opacity-80' : 'border-stone-300 hover:border-amber-400 focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500/20'
                        }`}
                >
                    <div className="flex items-end p-2">
                        {/* Context Icon */}
                        <div className="pl-3 py-3 text-stone-400">
                        ...
                        <textarea
                            ...
                            className="flex-1 max-h-[150px] bg-transparent border-none focus:ring-0 text-stone-800 placeholder-stone-400 resize-none py-3 px-3 min-h-[50px] font-inter leading-relaxed"
                            rows={1}
                            disabled={isLoading}
                        />
                        ...
                        <div className="flex items-center gap-1 mb-1 mr-1">
                            ...
                            <button
                                ...
                                className={`p-2 rounded-lg transition-colors duration-200 relative ${(!text.trim() && !selectedImage) || isLoading
                                        ...
                                        : 'bg-red-900 text-white hover:bg-red-800 shadow-md'
                                    }`}
                            >
                ...
                <div className="text-center mt-3">
                    <p className="text-[10px] text-stone-400 font-medium">
                        Atsakymai generuojami remiantis Katalikų Tradicija. Dėl asmeninio dvasinio vadovavimo visada kreipkitės į kunigą.
                    </p>
                </div>
            </div>
        </div>
